...
# ----------------------
  ...
  it '1. finds orders by amount' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders_of_500 = Order.search_500
    orders_of_200 = Order.search_200
    # ------------------------------------------------------------
  ...
  it '2. finds order id of smallest order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    order_id = Order.search_small.id
  ...
  it '4. finds orders of multiple amounts' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders_of_500_and_700 = Order.big_search1
    orders_of_700_and_1000 = Order.big_search2
    # ------------------------------------------------------------
  ...
  it '5. finds multiple items by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    items = Item.id_search(ids_to_find)
  ...
  it '6. finds multiple orders by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders = Order.order_id_search(ids_to_find)
    # ------------------------------------------------------------
  ...
  it '7. finds orders with an amount between 700 and 1000' do
    ...
    # ------------------ Using ActiveRecord ----------------------
orders_between_700_and_1000 = Order.between_700_and_1000
    # ------------------------------------------------------------
  ...
  it '8. finds orders with an amount less than 550' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders_less_than_550 = Order.less_550
    # ------------------------------------------------------------
