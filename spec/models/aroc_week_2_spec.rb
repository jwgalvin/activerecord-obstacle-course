...
# ----------------------
  ...
  it '9. finds orders for a user' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders_of_user_3 = Order.find_user_3(@user_3.id)
    # ------------------------------------------------------------
  ...
  it '10. sorts the orders from most expensive to least expensive' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders = Order.sort_order_expensive
    # ------------------------------------------------------------
  ...
  it '11. sorts the orders from least expensive to most expensive' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders = Order.sort_order_least_expensive
    # ------------------------------------------------------------
  ...
  it '12. should return all items except items 2, 5 and 6' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    items = Item.exclusionary(items_not_included)
    # ------------------------------------------------------------
    #binding.pry
    # Expectation
  ...
  it "13. groups an order's items by name" do
    ...
    order = Order.find(@order_3.id)
    # binding.pry
    grouped_items = order.sort_name_items
    # ------------------------------------------------------------
